...
const VividModelPage = () => {
  ...
  const specsTitle = language === 'ka' ? 'სპეციფიკაცია' : 'Specifications';
  const shortDescription = language === 'en'
        ...
        <div className="develop-model__wrapper">
          <div className="develop-model__header">
            <div className="develop-model__header-info">
              ...
              {shortDescription && (
                <p className="develop-model__spec-value" style={{ marginBottom: '1.25rem' }}>
                  {shortDescription}
                </p>
              )}
              <button
